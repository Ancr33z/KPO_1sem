...
int main()
{
	...
	wchar_t t7 = L'b';                // UTF-16

	wchar_t t8 = L'б';                // UTF-16

	short t9_1 = X;                   // 0000 1011 = 0x000B
	short t9_2 = -X;                  // 1000 1011 (п/к) = 1111 0100 (о/к) = 1111 0101 (д/к) = 0xFFF5
	...
	double t20_6 = 26.0005;           //0x414D0000 
